...
*/
    ...
    public boolean stillPossible(boolean nextValue){
        //this method returns false if the current solution would be impossible to finalize into a working solution, 
        //should it be extended from its current state with the value nextValue.
  
        if (m > 0 && m < height){
            if (board[m-1][n] == nextValue){
                return false;
            }
        }
